...
public class ControladorConsola {
	...
	public void ejecutaMovimiento(int x, int y) {
		...
		case GRAVITY:
			...
			break;
		case REVERSI:
			mov = new MovimientoReversi(x, y, turno);
			break;
		default:
		}
	...
	/**
	 * Indica si es el turno de un jugador automatico
	 */
	public boolean isTurnoAutomatico() {
		Ficha turno = getTurno();
		return partida.isAutomatico(turno);
	}
	...
	public void cambiarJuego(String juego, int filas, int columnas) {
		...
		} else if (juego.equalsIgnoreCase("reversi")) {
